...
void GamePlay::Init()
{
	// Prosze podac w trakcie uruchamiania sciezke do plikow
	m_context->m_assets->AddTexture(GRASS, "C:/Users/adamk/Desktop/03_semestr_zimowy/Jezyki_i_Paradygmaty_Programowania/projects/Snake_Game/Snake_game/assets/grass.png", true);
	m_context->m_assets->AddTexture(FOOD, "C:/Users/adamk/Desktop/03_semestr_zimowy/Jezyki_i_Paradygmaty_Programowania/projects/Snake_Game/Snake_game/assets/food.png");
	m_context->m_assets->AddTexture(WALL, "C:/Users/adamk/Desktop/03_semestr_zimowy/Jezyki_i_Paradygmaty_Programowania/projects/Snake_Game/Snake_game/assets/wall.png", true);
	m_context->m_assets->AddTexture(SNAKE, "C:/Users/adamk/Desktop/03_semestr_zimowy/Jezyki_i_Paradygmaty_Programowania/projects/Snake_Game/Snake_game/assets/snake.png");
	...
	m_walls[1].setPosition(0, (float)m_context->m_window->getSize().y - 16);

	m_walls[2].setTextureRect({0, 0, 16, 352});
	m_walls[3].setTextureRect({0, 0, 16, 352});
	m_walls[3].setPosition((float)m_context->m_window->getSize().x - 16, 0);
