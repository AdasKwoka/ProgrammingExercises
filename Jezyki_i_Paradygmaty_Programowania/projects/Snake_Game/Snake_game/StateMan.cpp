...
// Inicjalizacja trzech zmiennych w konstruktorze
...
void Engine::StateMan::ProcessStateChange()
{
	if (m_remove && (!m_stateStack.empty()))
	{
		...
		// Ustawienie usuwania z powrotem na false gdyby zostawic dalej true usunelo by wszystkie stany ze stosu
		m_remove = false;
	}
...
{
	// Zwraca stan ktory znajdzie sie na gorze stosu
