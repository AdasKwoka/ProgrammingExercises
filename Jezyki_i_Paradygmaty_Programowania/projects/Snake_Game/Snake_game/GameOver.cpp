...
void GameOver::Init()
{
	...
	m_gameOverTitle.setPosition((float)m_context->m_window->getSize().x / 2, m_context->m_window->getSize().y / 2 - 150.f);
	// Play Button
	...
	m_retryButton.setPosition((float)m_context->m_window->getSize().x / 2, (float)m_context->m_window->getSize().y / 2 - 25.f);
